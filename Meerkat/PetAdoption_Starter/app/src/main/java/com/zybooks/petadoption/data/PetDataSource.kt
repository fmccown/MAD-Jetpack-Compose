...
class PetDataSource {
   private val petList = listOf(
      ...
      Pet(
         ...
         gender = PetGender.MALE,
         age = 3,
         description = "Anton is looking for a family to take him home.",
         imageId = R.drawable.pet19
      ),
      Pet(
         id = 20,
         type = PetType.DOG,
         ...
         gender = PetGender.FEMALE,
         age = 2,
         description = "Samantha wants to be your best friend.",
         imageId = R.drawable.pet20
      ),
      Pet(
         id = 21,
         type = PetType.DOG,
         ...
         gender = PetGender.MALE,
         age = 3,
         description = "Davis is feisty and playful.",
         imageId = R.drawable.pet21
      )
   )
